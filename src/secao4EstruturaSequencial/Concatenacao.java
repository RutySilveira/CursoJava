...
public class Concatenacao {
  ...
  public static void main(String[] args) {
    ...
    // Declara uma variável do tipo String chamada 'nome' e atribui a ela o valor
    // "Maria"
    String nome = "Maria";
    ...
    // Declara uma variável do tipo double chamada 'renda' e atribui a ela o valor
    // 4000.0
    double renda = 4000.0;

    // Usa o método printf para formatar e imprimir a string no console
    // %s é um placeholder para uma string (nome), %d para um inteiro (idade) e %.2f
    // para um número de ponto flutuante com duas casas decimais (renda)
